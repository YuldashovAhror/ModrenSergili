                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        @foreach($galleries as $gallery)
                            <tr>
                                <th scope="row">{{ $k }}</th>
                                <td><img src="{{ $gallery->photo }}" alt="" style="height: 100px; width: 200px"></td>
                                <td>{{ $gallery->data }}</td>
                                <td class="text-center">
                                    <button class="btn btn-xs btn-success" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalCenter{{ $gallery->id }}Edit"><i data-feather="edit-2"></i></button>
                                    <div class="modal fade" id="exampleModalCenter{{ $gallery->id }}Edit" tabindex="-1" aria-labelledby="exampleModalCenter" style="display: none;" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('dashboard.gallery.update', $gallery) }}" method="post" enctype="multipart/form-data">
                                                        @csrf
                                                        {{ method_field('put') }}
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <div class="mb-3">
                                                                        <label class="form-label" for="exampleFormControlInput1">Фото</label>
                                                                        <div class="col-12 text-center">
                                                                            <img style="height: 200px; width: 300px" src="{{ $gallery->photo }}">
                                                                        </div>
                                                                        <input class="form-control" id="exampleFormControlInput1" type="file" name="photo">
                                                                    </div>
                                                                </div>
                                                                <div class="col-12">
                                                                    <div class="mb-3">
                                                                        <label class="form-label" for="exampleFormControlInput1">Дата</label>
                                                                        <input class="form-control" id="exampleFormControlInput1" type="text" name="data" value="{{ $gallery->data }}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <button class="btn btn-xs btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalCenter{{ $gallery->id }}"><i data-feather="trash"></i></button>
